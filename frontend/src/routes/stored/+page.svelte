...
<div class="card p-6 bg-secondary-800 text-left" style="max-width:800px; width:100%;">
	<div class="card-body">
		...
		<p>
			...
			not know that the script shouldn't be trusted
			<Citation id={6} />.
		</p>
		<p class="mt-4">An example forum is available to demonstrate this concept here:</p>
		<a class="btn btn-sm bg-secondary-700 rounded mt-1" href="/forum">Forum</a>
		...
		<p>
			...
			prevent the user bypassing the client side validation <Citation id={7} />.
		</p>
	</div>
</div>
